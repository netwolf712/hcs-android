 ...
 * 床头分机配置模板
 */
public class BedScreenTemplate extends SlaveTemplate{
    /**
     * 屏保提示语
     */
     ...
     * 外接按钮设置
     */
    private HotkeyBo externalHotkey;
    public HotkeyBo getExternalHotkey(){
        return externalHotkey;
    }
    public void setExternalHotkey(HotkeyBo externalHotkey){
        this.externalHotkey = externalHotkey;
    }

    /**
     * 手持按钮设置
     */
    private HotkeyBo inHandHotkey;
    public HotkeyBo getInHandHotkey(){
        return inHandHotkey;
    }
    public void setInHandHotkey(HotkeyBo inHandHotkey){
        this.inHandHotkey = inHandHotkey;
    }
}
