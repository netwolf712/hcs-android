...
//    private WriteFileUtil util;
    ...
    public SetImagingSettingsThread(OnvifDevice device, Context context, SetImagingSettingsCallBack callBack) {
        this.device = device;
...
//        util = new WriteFileUtil("onvif.txt");
    ...
    public interface SetImagingSettingsCallBack {
        void setImagingSettingsThreadResult(boolean isSuccess, OnvifDevice device, String errorMsg);
    }
