...
public class NetConfigBo  extends BaseObservable {
    /**
     * 网络名称
     */
    private String name;
    ...
    public void setGateway(String gateway){
        ...
        notifyPropertyChanged(BR.gateway);
    }
    ...
    public void setLinkMode(String linkMode){
        ...
        notifyPropertyChanged(BR.linkMode);
    }
    ...
    public void copyOthers(NetConfig netConfig)
    {
        ...
        this.name = netConfig.getName();
        this.displayName = netConfig.getDisplayName();
    }
    public NetConfig asNetConfig(){
        NetConfig netConfig = new NetConfig();
        netConfig.setName(name);
        netConfig.setHardwareAddress(hardwareAddress);
        netConfig.setNetType(netType);
        netConfig.setLinkId(linkId);
        netConfig.setDns1(dns1);
        netConfig.setDns2(dns2);
        netConfig.setGateway(gateway);
        netConfig.setMask(mask);
        netConfig.setIpAddress(ipAddress);
        netConfig.setIpAddress6(ipAddress6);
        netConfig.setLinkMode(linkMode);
        netConfig.setDisplayName(displayName);
        netConfig.setBandwidth(bandwidth);
        return netConfig;
    }
}
