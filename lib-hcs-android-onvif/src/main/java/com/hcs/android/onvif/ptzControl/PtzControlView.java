package com.hcs.android.onvif.ptzControl;
...
import com.hcs.android.onvif.R;
...
public class PtzControlView extends View implements View.OnTouchListener {
    ...
    public PtzControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //背景色
        bgViewColor = a.getColor(R.styleable.PtzControlView_bgViewColor, Color.WHITE);
        // 常态下边框颜色
        strokeColor = a.getColor(R.styleable.PtzControlView_PtzControlStrokeColor, Color.BLUE);
        //边框宽度
        strokeWidth = a.getDimensionPixelSize(R.styleable.PtzControlView_PtzControlStrokeWidth, (int) TypedValue.applyDimension(
