package com.hcs.android.call.receivers;
/*
...
public class BluetoothManager extends BroadcastReceiver {
    ...
    private void checkBluetoothConnectPermission(){
        if(!PermissionCheckUtil.checkPermission(Manifest.permission.BLUETOOTH_CONNECT)){
    ...
    public void onReceive(Context context, Intent intent) {
        if (!LinphoneManager.isInstanced()) return;
