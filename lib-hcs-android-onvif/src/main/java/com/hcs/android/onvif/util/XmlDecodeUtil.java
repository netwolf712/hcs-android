package com.hcs.android.onvif.util;

import android.util.Xml;

import com.hcs.android.onvif.onvifBean.ImageSetting;
...
public class XmlDecodeUtil {
     ...
     * 获取设备信息
     */
    public static OnvifDevice getDeviceInfo(String xml) throws Exception {
     ...
     */
    public static void getCapabilitiesUrl(String xml, OnvifDevice device) throws Exception {
        XmlPullParser parser = Xml.newPullParser();
        InputStream input = new ByteArrayInputStream(xml.getBytes());
        parser.setInput(input, "UTF-8");
        int eventType = parser.getEventType();
     ...
     * @param device 对应的device
     */
    public static void getDeviceInformation(String xml, OnvifDevice device) throws Exception {
        XmlPullParser parser = Xml.newPullParser();
        InputStream input = new ByteArrayInputStream(xml.getBytes());
        parser.setInput(input, "UTF-8");
        int eventType = parser.getEventType();
     ...
     * @param device 对应的device
     */
    public static void getGetImageSetting(String xml, OnvifDevice device) throws Exception {
        XmlPullParser parser = Xml.newPullParser();
        InputStream input = new ByteArrayInputStream(xml.getBytes());
        String tag = "";
        parser.setInput(input, "UTF-8");
     ...
     * @param device 对应的device
     */
    public static void getNetworkInterface(String xml, OnvifDevice device) throws Exception {
