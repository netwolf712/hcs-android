...
public class DateUtil {
    ...
    public enum FormatType {
        yyyy, yyyyMM, yyyyMMdd, yyyyMMddHHmm, yyyyMMddHHmmss, MMdd, HHmm,MM,dd,MMddHHmm,yyyyMMdd_HHmmss,yyyyMMdd2
    }
    /**
     * 格式化时间字符串
     */
    ...
    @SuppressLint("SimpleDateFormat")
    private static SimpleDateFormat getSimpleDateFormat(@NonNull FormatType type) {
    ...
    public static String formatSecondToHourMinuteSecond(long second) {
        long h = 0;
        long d = 0;
        long s = 0;
    ...
    public static String getSysTime() {
        @SuppressLint("SimpleDateFormat") SimpleDateFormat tempDate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
